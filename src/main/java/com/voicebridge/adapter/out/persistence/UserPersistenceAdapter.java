...
public class UserPersistenceAdapter implements UserRepositoryPort {
    ...
    private static User toDomain(UserJpaEntity entity) {
        return User.reconstitute(entity.getId(), entity.getEmail(), entity.getPassword(),
                entity.getNickname(), entity.getProvider(), entity.getProviderId(), entity.getCreatedAt());
    }
}
